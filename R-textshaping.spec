...
Version  : 0.4.1
Release  : 35
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/textshaping_0.4.1.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/textshaping_0.4.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733581799
