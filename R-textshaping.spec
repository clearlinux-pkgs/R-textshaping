...
Version  : 0.3.5
Release  : 15
URL      : https://cran.r-project.org/src/contrib/textshaping_0.3.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/textshaping_0.3.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623270651
