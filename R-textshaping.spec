...
Version  : 0.3.3
Release  : 10
URL      : https://cran.r-project.org/src/contrib/textshaping_0.3.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/textshaping_0.3.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615909899
