...
Version  : 0.2.1
Release  : 3
URL      : https://cran.r-project.org/src/contrib/textshaping_0.2.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/textshaping_0.2.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605285427
