...
Version  : 0.3.7
Release  : 30
URL      : https://cran.r-project.org/src/contrib/textshaping_0.3.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/textshaping_0.3.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696896701
