...
Version  : 1.0.0
Release  : 36
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/textshaping_1.0.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/textshaping_1.0.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737474293
