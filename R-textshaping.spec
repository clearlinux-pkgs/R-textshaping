...
Version  : 0.3.0
Release  : 4
URL      : https://cran.r-project.org/src/contrib/textshaping_0.3.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/textshaping_0.3.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612974523
